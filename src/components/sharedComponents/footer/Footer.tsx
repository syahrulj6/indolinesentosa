  ...
  return (
    <footer className="bg-primary w-full py-4">
      <div className=" flex flex-col md:flex-row items-center justify-between mx-12 gap-4">
        ...
        <div className="flex flex-1 text-white flex-col gap-3 ">
          <div>
          ...
          <div className="flex gap-2 text-white justify-center md:justify-start  items-center ">
        ...
        <div className="flex flex-1 text-white flex-col gap-3 ">
          ...
          <div className="flex gap-2 text-white justify-center md:justify-start  items-center">
            <FaPhoneAlt className="text-2xl" />
            <h3 className=" text-xl md:text-xl">+62 81355430158</h3>
          </div>
        </div>
      </div>
    </footer>
